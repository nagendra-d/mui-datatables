...
class MUIDataTable extends React.Component {
  ...
  static defaultProps = {
    ...
    components: {
      ...
      Tooltip: MuiTooltip,
      TableWrapper: this.DefaultTableWrapper,
    },
  };
  ...
  render() {
    ...
    const TableWrapperComponent = TableWrapper || this.DefaultTableWrapper;
            ...
            const components = (
              <TableWrapperComponent>
                <MuiTable
                  ...
                  tabIndex={'0'}
                  role={'grid'}
                  className={clsx(tableClassNames, 'test-table', { 'empty-table': !rowCount })}
                  {...tableProps}>
                  <caption className={classes.caption}>{title}-{rowCount}</caption>
                  <TableHeadComponent
                    columns={columns}
